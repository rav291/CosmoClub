...
const ProductEditScreen = ({ match, history }) => {
  ...
  const uploadFileHandler = async (e) => {
    const file = e.target.files[0]; // this gives an array consisting of files uploaded, since we can upload multiple files.
    // '0' ofcourse gives the 1st item in that array.
